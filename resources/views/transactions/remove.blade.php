...
@section('title')
  <h1 class='title appTitle'>Списание препарата со склада</h1>
@endsection
...
@section('content')
  <div class='box appForm-container'>
    <form action='/transactions/refresh' method='POST'>
      ...
      <div class='field'>
        <label for='expense' class='label'>Колличество</label>
        <div class='control'>
          <input class="input" type='number' id='expense' name='expense' required
                 value='1'
